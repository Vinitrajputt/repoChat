...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.selection_states = {}   # Mapping: relative path -> bool (True if selected)
    ...
    def setup_ui(self):
        ...
        # Apply additional styling via stylesheet
        self.setStyleSheet("""
            QWidget {
    ...
    def update_folder_view(self):
        ...
        for item in items:
            ...
            # Default selection state is True unless changed
            ...
            # Set icon based on file or folder
            if is_dir:
            ...
            # For hidden files/folders (those starting with a dot), set the text color to gray.
            if item.startswith('.'):
                lw_item.setForeground(QtGui.QBrush(QtGui.QColor("gray")))
    ...
    def get_selection_state(self, rel_path):
        ...
        Default is True unless a parent folder is deselected.
        """
    ...
    def generate_pdf(self):
        ...
        # Add project structure at the top
...
if __name__ == "__main__":
    ...
    # Use Fusion style for a modern look and apply a dark palette.
    app.setStyle("Fusion")
